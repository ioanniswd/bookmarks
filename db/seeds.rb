...
b11 = Book.create(title: "Il Principe", author: "Niccolo Machiavelli", description: "A guide on how to conquer a country during the Renaissance", publisher: "Antonio Blado d'Asola", weeks_on_list: 25387, rank_this_week: 11)
b12 = Book.create(title: "Totem and Taboo", author: "Sigmund Freud", description: "Thoughts and analysis on projection, superstitions and taboo based on tribe civilizations", publisher: "Beacon Press", weeks_on_list: 5531, rank_this_week: 12)
...
Review.create(comment: "A great way to conquer a country and get out of a Florence prison.", author: "John Poulis", book_id: b11.id)
Review.create(comment: "A hard to follow but invaluable piece of text for anyone interested in psychology.", author: "John Poulis", book_id: b12.id)
